<?php 
    session_start();
    $_SESSION["next"] = "order";
    header("location: account/user_login.php?next=order"); 
    exit();
?>
<html>
    ...
    <body style="overflow-x: hidden;">
        ...
        <div class="container1">
            ...
            <div class="box shadow">
                ...
                <p style="padding-top: 15px;">You must be logged in to order from us. <a class = "link" href="account/user_login.php">Click here</a> to log in.</p>
